...
class StableUnCLIPImg2ImgPipeline(
    ...
    def __call__(
        ...
        prompt_embeds: Optional[torch.Tensor] = None,
        prompt_embeds_2: Optional[torch.Tensor] = None, # Change: Added prompt_embeds_2
        negative_prompt_embeds: Optional[torch.Tensor] = None,
        negative_prompt_embeds_2: Optional[torch.Tensor] = None, # Change: Added negative_prompt_embeds_2
        ...
        image_embeds_2: Optional[torch.Tensor] = None, # Change: Added image_embeds_2
        clip_skip: Optional[int] = None,
        avg_img: int = 1,
        interpolation_type: str = "decline",
    ):
        r"""
        ...
        # set the second default to the first one
        if image_2 == None:
            image_2 = image
        if prompt_embeds_2 == None:
            prompt_embeds_2 = prompt_embeds
        if image_embeds_2 == None:
            image_embeds_2 = image_embeds
        if negative_prompt_embeds_2 == None:
            negative_prompt_embeds_2 = negative_prompt_embeds
        ...
        image_embeds_2 = self._encode_image(
            image=image_2,
            device=device,
            batch_size=batch_size,
            num_images_per_prompt=num_images_per_prompt,
        ...
        if avg_img == 1:
            ...
            image_embeds = (image_embeds + image_embeds_2) / 2
            image_embeds_2 = image_embeds
